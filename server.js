// server.js (Stable version - Node 22 + Express + PostgreSQL + JWT)
...
// ----------------------------------------------------
// 2. مصادقة (Auth + Refresh)
// ----------------------------------------------------

// Auth: توليد Access و Refresh tokens
...
// 📌 لأي API route مش متعرف
app.use(/^\/api\/.*/, (req, res) => {
  res.status(404).json({ message: "API endpoint not found." });
});

// 📌 لو عايز تخدم Frontend (اختياري - علّق لو مش محتاج)
